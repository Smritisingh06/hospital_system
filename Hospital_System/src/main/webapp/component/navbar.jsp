...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container-fluid">
    <a class="navbar-brand" href="index.jsp"><i class="fas fa-clinic-medical"></i> MediCare </a>
      ...
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
       ...
       <c:if test="${empty userObj }">
        ...
        <c:if test="${not empty userObj }">
          <li class="nav-item">
         <li><a href="user_appointment.jsp">APPPOINTMENT</a></li>
				<li><a href="view_appointment.jsp">APPPOINTMENT</a></li>
